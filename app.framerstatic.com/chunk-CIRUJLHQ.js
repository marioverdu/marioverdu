...
function useCreateMotionContext(props) {
  const { initial, animate: animate3 } = getCurrentTreeVariants(
    props,
    useContext3(MotionContext)
  );
  return useMemo(
    () => ({ initial, animate: animate3 }),
...
var isMotionValue = (value) =>
  !!(value === null || value === void 0 ? void 0 : value.getVelocity);
...
var sortTransformProps = (a, b) =>
  transformPropOrder.indexOf(a) - transformPropOrder.indexOf(b);
function buildTransform(
  { transform: transform2, transformKeys: transformKeys2 },
...
function makeLatestValues(props, context, presenceContext, scrapeMotionValues) {
  ...
  if (
    ...
    if (animate3 === void 0) animate3 = context.animate;
  }
...
function getOrigin(target, transition, visualElement) {
  ...
  for (const key in target) {
    ...
    origin[key] =
      transitionOrigin !== void 0
        ? transitionOrigin
        : (_a = visualElement.getValue(key)) === null || _a === void 0
        ? void 0
        : _a.get();
  }
  return origin;
...
function animate({
  ...
  const animator =
    types[keyframes$1.length > 2 ? "keyframes" : type] || keyframes;
  const origin = keyframes$1[0];
  const target = keyframes$1[keyframes$1.length - 1];
  let state = { done: false, value: origin };
  if (
    (_b = (_a = animator).needsInterpolation) === null || _b === void 0
      ? void 0
      : _b.call(_a, origin, target)
  ) {
  ...
  function update(delta) {
    ...
    if (isComplete) {
      if (repeatCount === 0) {
        computedDuration =
          computedDuration !== void 0 ? computedDuration : elapsed;
      }
...
function animateStyle(
  ...
  return element.animate(
    { [valueName]: keyframes2, offset: times },
    {
      delay: delay2,
      duration,
...
var createMotionValueAnimation = (
  valueName,
  value,
  target,
  transition = {}
...
function updateMotionValuesFromProps(element, next, prev) {
  ...
  for (const key in next) {
    ...
    if (isMotionValue(nextValue)) {
      ...
      if (false) {
        warnOnce(
          nextValue.version === "8.5.3",
          `Attempting to mix Framer Motion versions ${nextValue.version} with 8.5.3 may not work as expected.`
        );
      }
...
var VisualElement = class {
  constructor(
    { parent, props, reducedMotionConfig, visualState },
    options = {}
  ) {
    this.current = null;
  ...
  unmount() {
    ...
    (_b = this.removeFromVariantTree) === null || _b === void 0
      ? void 0
      : _b.call(this);
    (_c = this.parent) === null || _c === void 0
      ? void 0
      : _c.children.delete(this);
  ...
  getVariant(name) {
    var _a;
    return (_a = this.props.variants) === null || _a === void 0
      ? void 0
      : _a[name];
  }
  /**
  ...
  getClosestVariantNode() {
    ...
    return this.isVariantNode
      ...
      : (_a = this.parent) === null || _a === void 0
      ? void 0
      : _a.getClosestVariantNode();
  }
  getVariantContext(startAtParent = false) {
    var _a, _b;
    if (startAtParent)
      return (_a = this.parent) === null || _a === void 0
        ? void 0
        : _a.getVariantContext();
    if (!this.isControllingVariants) {
      const context2 =
        ((_b = this.parent) === null || _b === void 0
          ? void 0
          : _b.getVariantContext()) || {};
  ...
  addVariantChild(child) {
    ...
    if (closestVariantNode) {
      (_a = closestVariantNode.variantChildren) === null || _a === void 0
        ? void 0
        : _a.add(child);
  ...
  removeValue(key) {
    ...
    (_a = this.valueSubscriptions.get(key)) === null || _a === void 0
      ? void 0
      : _a();
  ...
  notify(eventName, ...args) {
    var _a;
    (_a = this.events[eventName]) === null || _a === void 0
      ? void 0
      : _a.notify(...args);
  }
};
...
function useTapGesture({
  ...
  function onPointerUp(event, info) {
    ...
    !isNodeOrChild(visualElement.current, event.target)
      ? (_b = (_a = visualElement.getProps()).onTapCancel) === null ||
        _b === void 0
        ? void 0
        : _b.call(_a, event, info)
      : (_d = (_c = visualElement.getProps()).onTap) === null || _d === void 0
      ? void 0
      : _d.call(_c, event, info);
  }
  function onPointerCancel(event, info) {
    var _a, _b;
    if (!checkPointerEnd()) return;
    (_b = (_a = visualElement.getProps()).onTapCancel) === null || _b === void 0
      ? void 0
      : _b.call(_a, event, info);
  }
  const startPress = useCallback3(
    (event, info) => {
      var _a;
      removePointerEndListener();
      ...
      (_a = latestProps.onTapStart) === null || _a === void 0
        ? void 0
        : _a.call(latestProps, event, info);
    },
  ...
  usePointerEvent(
    visualElement,
    "pointerdown",
    hasPressListeners ? startPress : void 0,
    eventOptions
  );
...
function useIntersectionObserver(
  ...
  state,
  visualElement,
  { root, margin: rootMargin, amount = "some", once }
) {
  useEffect7(() => {
...
function applyTreeDeltas(box, treeScale, treePath, isSharedTransition = false) {
  ...
  for (let i = 0; i < treeLength; i++) {
    ...
    if (
      ((_b =
        (_a = node.instance) === null || _a === void 0 ? void 0 : _a.style) ===
        null || _b === void 0
        ? void 0
        : _b.display) === "contents"
    )
...
function transformAxis(axis, transforms, [key, scaleKey, originKey]) {
  const axisOrigin =
    transforms[originKey] !== void 0 ? transforms[originKey] : 0.5;
...
var VisualElementDragControls = class {
    ...
    const onStart = (event, info) => {
      ...
      eachAxis((axis) => {
        ...
        if (percent.test(current)) {
          const measuredAxis =
            (_b =
              (_a2 = this.visualElement.projection) === null || _a2 === void 0
                ? void 0
                : _a2.layout) === null || _b === void 0
              ? void 0
              : _b.layoutBox[axis];
          if (measuredAxis) {
      ...
      (_a = this.visualElement.animationState) === null || _a === void 0
        ? void 0
        : _a.setActive(AnimationType.Drag, true);
    };
  ...
  cancel() {
    ...
    (_b = this.visualElement.animationState) === null || _b === void 0
      ? void 0
      : _b.setActive(AnimationType.Drag, false);
  }
  ...
  getAxisMotionValue(axis) {
    ...
    return externalMotionValue
      ...
      : this.visualElement.getValue(
          axis,
          ((_a = this.visualElement.getProps().initial) === null ||
          _a === void 0
            ? void 0
            : _a[axis]) || 0
        );
  ...
  scalePositionWithinConstraints() {
    ...
    this.visualElement.current.style.transform = transformTemplate
      ? transformTemplate({}, "")
      : "none";
    (_a = projection.root) === null || _a === void 0
      ? void 0
      : _a.updateScroll();
...
function resolveCSSVariables(visualElement, { ...target }, transitionEnd) {
  ...
  visualElement.values.forEach((value) => {
    ...
    if (!isCSSVariable2(current)) return;
...
var SVGVisualElement = class extends DOMVisualElement {
  ...
  readValueFromInstance(instance, key) {
    ...
    if (transformProps.has(key)) {
      return (
        ((_a = getDefaultValueType(key)) === null || _a === void 0
          ? void 0
          : _a.default) || 0
      );
    }
    ...
    if (prevProps.isPresent !== isPresent2) {
      if (isPresent2) {
        ...
        sync.postRender(() => {
          var _a;
          if (
            !((_a = projection.getStack()) === null || _a === void 0
              ? void 0
              : _a.members.length)
          ) {
            this.safeToRemove();
...
function MeasureLayout(props) {
  ...
  return React__default2.createElement(MeasureLayoutWithContext, {
    ...props,
    layoutGroup,
    switchLayoutGroup: useContext9(SwitchLayoutGroupContext),
    isPresent: isPresent2,
    safeToRemove,
  });
}
  ...
  for (let i = 0; i < numBorders; i++) {
    ...
    if (canMix) {
      target[borderLabel] = Math.max(
        mix(asNumber(followRadius), asNumber(leadRadius), progress3),
        0
      );
...
var NodeStack = class {
  ...
  exitAnimationComplete() {
    this.members.forEach((node) => {
      var _a, _b, _c, _d, _e;
      (_b = (_a = node.options).onExitComplete) === null || _b === void 0
        ? void 0
        : _b.call(_a);
      (_e =
        (_c = node.resumingFrom) === null || _c === void 0
          ? void 0
          : (_d = _c.options).onExitComplete) === null || _e === void 0
        ? void 0
        : _e.call(_d);
    });
  }
...
function createProjectionNode({
  ...
  return class ProjectionNode {
        ...
        this.addEventListener(
          ...
          ({
            ...
            const layoutTransition =
              (_b =
                (_a2 = this.options.transition) !== null && _a2 !== void 0
                  ? _a2
                  : visualElement.getDefaultTransition()) !== null &&
              _b !== void 0
                ? _b
            ...
            if (
              ...
              ((_c = this.resumeFrom) === null || _c === void 0
                ? void 0
                : _c.instance) ||
              ...
              this.isLead() &&
                ((_e = (_d = this.options).onExitComplete) === null ||
                _e === void 0
                  ? void 0
                  : _e.call(_d));
            }
    ...
    startUpdate() {
      ...
      (_a = this.nodes) === null || _a === void 0
        ? void 0
        : _a.forEach(resetRotation);
      this.animationId++;
    }
    getTransformTemplate() {
      var _a;
      return (_a = this.options.visualElement) === null || _a === void 0
        ? void 0
        : _a.getProps().transformTemplate;
    }
    willUpdate(shouldNotifyListeners = true) {
      var _a, _b, _c;
      if (this.root.isUpdateBlocked()) {
        (_b = (_a = this.options).onExitComplete) === null || _b === void 0
          ? void 0
          : _b.call(_a);
        return;
      }
      ...
      this.prevTransformTemplateValue =
        (_c = this.getTransformTemplate()) === null || _c === void 0
          ? void 0
          : _c(this.latestValues, "");
      this.updateSnapshot();
    ...
    resetTransform() {
      ...
      const transformTemplateValue =
        (_a = this.getTransformTemplate()) === null || _a === void 0
          ? void 0
          : _a(this.latestValues, "");
    ...
    removeTransform(box) {
      ...
      for (let i = 0; i < this.path.length; i++) {
        ...
        removeBoxTransforms(
          boxWithoutTransform,
          node.latestValues,
          (_a = node.snapshot) === null || _a === void 0
            ? void 0
            : _a.layoutBox,
          sourceBox
        );
    ...
    resolveTargetDelta() {
      ...
      if (
        this.relativeTarget &&
        this.relativeTargetOrigin &&
        ((_a = this.relativeParent) === null || _a === void 0
          ? void 0
          : _a.target)
      ) {
        calcRelativeBox(
    ...
    scheduleRender(notifyAll2 = true) {
      var _a, _b, _c;
      (_b = (_a = this.options).scheduleRender) === null || _b === void 0
        ? void 0
        : _b.call(_a);
      notifyAll2 &&
        ((_c = this.getStack()) === null || _c === void 0
          ? void 0
          : _c.scheduleRender());
    ...
    setAnimationOrigin(delta, hasOnlyRelativeTargetChanged = false) {
      ...
      const isSharedLayoutAnimation =
        (snapshot === null || snapshot === void 0
          ? void 0
          : snapshot.source) !==
        ((_a = this.layout) === null || _a === void 0 ? void 0 : _a.source);
      const isOnlyMember =
        (((_b = this.getStack()) === null || _b === void 0
          ? void 0
          : _b.members.length) || 0) <= 1;
      ...
      this.mixTargetDelta = (latest) => {
        ...
        if (
          ...
          this.relativeTargetOrigin &&
          this.layout &&
          ((_a2 = this.relativeParent) === null || _a2 === void 0
            ? void 0
            : _a2.layout)
        ) {
          calcRelativePosition(
    ...
    startAnimation(options) {
      ...
      (_a = this.currentAnimation) === null || _a === void 0
        ? void 0
        : _a.stop();
      if (this.resumingFrom) {
        (_b = this.resumingFrom.currentAnimation) === null || _b === void 0
          ? void 0
          : _b.stop();
      }
      ...
      this.pendingAnimation = sync.update(() => {
        ...
        this.currentAnimation = animate2(0, animationTarget, {
          ...
          onUpdate: (latest) => {
            var _a2;
            this.mixTargetDelta(latest);
            (_a2 = options.onUpdate) === null || _a2 === void 0
              ? void 0
              : _a2.call(options, latest);
          },
          onComplete: () => {
            var _a2;
            (_a2 = options.onComplete) === null || _a2 === void 0
              ? void 0
              : _a2.call(options);
    ...
    finishAnimation() {
      ...
      if (this.currentAnimation) {
        (_a = this.mixTargetDelta) === null || _a === void 0
          ? void 0
          : _a.call(this, animationTarget);
    ...
    registerSharedNode(layoutId, node) {
      ...
      node.promote({
        transition:
          (_a = node.options.initialPromotionConfig) === null || _a === void 0
            ? void 0
            : _a.transition,
        preserveFollowOpacity:
          (_c =
            (_b = node.options.initialPromotionConfig) === null || _b === void 0
              ? void 0
...
function notifyLayoutUpdate(node) {
  ...
  if (
    ...
    (_c = (_b = node.options).onExitComplete) === null || _c === void 0
      ? void 0
      : _c.call(_b);
  }
...
function mountNodeEarly(node, elementId) {
  ...
  const element = searchElement.querySelector(
...
var motion = /* @__PURE__ */ createMotionProxy((Component2, config) =>
...
function useForceUpdate() {
  ...
  const deferredForceRender = useCallback4(
...
function PopChild({ children, isPresent: isPresent2 }) {
  ...
  return React2.createElement(
    PopChildMeasure,
    { isPresent: isPresent2, childRef: ref, sizeRef: size },
...
var LayoutGroup = ({ children, id: id4, inheritId, inherit = true }) => {
  if (inheritId !== void 0) inherit = inheritId;
  const layoutGroupContext = useContext11(LayoutGroupContext);
  const deprecatedLayoutGroupContext = useContext11(
  ...
  const memoizedContext = useMemo7(
...
function ReorderItem(
  { children, style = {}, value, as = "li", onDrag, layout = true, ...props },
  externalRef
) {
  const Component2 = useConstant(() => motion(as));
  ...
  return React10.createElement(
    Component2,
    {
      ...
      onDrag: (event, gesturePoint) => {
        ...
        velocity[axis] &&
          updateOrder(value, point2[axis].get(), velocity[axis]);
...
function interpolate2(
  output,
  input = defaultOffset2(output.length),
  easing = noopReturn
) {
...
function updateAxisInfo(element, axisName, info, time) {
  ...
  axis.velocity =
    elapsed > maxElapsed2
      ? 0
      : velocityPerSecond2(axis.current - prev, elapsed);
}
...
function resolveOffsets(container, info, options) {
  ...
  if (hasChanged) {
    info[axis].interpolate = interpolate2(
      defaultOffset2(numOffsets),
      info[axis].offset
    );
...
function scroll(onScroll, _a = {}) {
  ...
  return () => {
    ...
    if (listener2) {
      ...
      (_a2 = resizeListeners.get(container)) === null || _a2 === void 0
        ? void 0
        : _a2();
...
function useCycle(...items) {
  ...
  const runCycle = useCallback5(
    (next) => {
      index.current =
        typeof next !== "number"
          ? wrap2(0, items.length, index.current + 1)
          : next;
...
//# sourceMappingURL=chunk-CIRUJLHQ.js.map
